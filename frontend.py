...
def search_command():
    list.delete(0,END)
    for row in backend.search(name_text.get(),date_text.get(),email_text.get(),age_text.get(),birthdate_text.get(),location_text.get()):
        list.insert(END,row)

def add_command():
    backend.insert(name_text.get(),date_text.get(),email_text.get(),age_text.get(),birthdate_text.get(),location_text.get())

    list.delete(0,END)
    list.insert(END,(name_text.get(),date_text.get(),email_text.get(),age_text.get(),birthdate_text.get(),location_text.get()))
...
l2 = Label(win, text='date')
l2.grid(row=0,column=2)
l3 = Label(win, text='email')
l3.grid(row=1,column=0)
l4 = Label(win, text='age')
l4.grid(row=1,column=2)
l5 = Label(win, text='birthdate')
l5.grid(row=2,column=0)
l6 = Label(win, text='location')
...
date_text = StringVar()
e2 = Entry(win, textvariable=date_text)
e2.grid(row=0,column=3)

email_text = StringVar()
e3 = Entry(win, textvariable=email_text)
e3.grid(row=1,column=1)

age_text = StringVar()
e4 = Entry(win, textvariable=age_text)
e4.grid(row=1,column=3)

birthdate_text = StringVar()
e5 = Entry(win, textvariable=birthdate_text)
e5.grid(row=2,column=1)

location_text = StringVar()
e6 = Entry(win, textvariable=location_text)
